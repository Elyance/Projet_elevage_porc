...
ALTER TABLE bao_portee ADD COLUMN id_cycle_reproduction INTEGER;
ALTER TABLE bao_portee ADD CONSTRAINT fk_cycle_reproduction FOREIGN KEY (id_cycle_reproduction) REFERENCES bao_cycle_reproduction(id_cycle_reproduction);
