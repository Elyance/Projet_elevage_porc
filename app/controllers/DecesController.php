...
class DecesController
{
    public function home()
    {
        ...
        Flight::render('deces/listDeces', ['deces' => $deces]);
    }
    ...
    public function formAddDeces()
    {
        ...
        Flight::render('deces/createDeces', ['enclos' => $enclos->findAll()]); // vue à créer : deces/add.php
    }
    ...
    public function formUpdateDeces($id)
    {
        ...
        Flight::render('deces/updateDeces', $data);
    }
