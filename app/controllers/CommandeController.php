...
class CommandeController
{
    ...
    public function list()
    {
        ...
        $content = Flight::view()->fetch('commande/liste', [
            "commands" => $commands,
        ...
        //     'page' => 'commande/liste'
        // ];
        // Flight::render('template-quixlab', $data);
    }
    ...
    public function form()
    {
        ...
        $content = Flight::view()->fetch('commande/commande', [
            "clients" => $clients,
            'enclos_portees' => $enclos_portees,
            'races' => $races,
            "links" => [
    ...
    public function editStatus($id)
    {
        ...
        $content = Flight::view()->fetch('commande/edit_status', [
            'command' => $command,
            "links" => [
                "gestion_salaire" => "/salaire",
                "gestion_presence" => "/presence",
    ...
    public function recette()
    {
        ...
        $content = Flight::view()->fetch('commande/recette', [
            "recettes" => $recettes,
            'date_debut' => Flight::request()->query['date_debut'] ?? '',
            'date_fin' => Flight::request()->query['date_fin'] ?? '',
            'total_recette' => $total_recette,
