                            ...
                            <tbody>
                                <?php foreach ($diagnostics as $diag): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= BASE_URL ?>/diagnostic/formMoveToQuarantine/<?= htmlspecialchars($diag['id_diagnostic']) ?>" class="btn btn-primary btn-sm">
                                                <i class="fa fa-shield"></i> Mettre en quarantaine
                                            </a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
