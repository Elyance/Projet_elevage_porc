            ...
            <div class="nk-sidebar">
                <div class="nk-nav-scroll">
                    <ul class="metismenu" id="menu">
                        <li>
                            <a href="/typePorc" aria-expanded="false">
                                <i class="icon-badge menu-icon"></i><span class="nav-text">Type Porc</span>
                            </a>
                        </li>
                        <br>
                        <li>
                            <a href="/enclos" aria-expanded="false">
                                <i class="icon-badge menu-icon"></i><span class="nav-text">Enclos</span>
                            </a>
                        </li>
